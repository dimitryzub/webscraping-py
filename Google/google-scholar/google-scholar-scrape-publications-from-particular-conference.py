# blog post: https://serpapi.com/blog/scrape-google-scholar-papers-within-a-particular-conference-in-python/
...
scrape_conference_publications(query="anatomy", source="NIPS")